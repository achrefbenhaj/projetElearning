...
class CourseController extends Controller
{
    ...
    public function StoreCourse(Request $request){
        ...
        if(isset($_FILES['image'])) {
            ...
            // Vérifie si le téléchargement de l'image s'est bien passé
            if($image['error'] === UPLOAD_ERR_OK) {
                ...
                // Faites ce que vous devez faire avec le nom généré, par exemple :
                // move_uploaded_file($image['tmp_name'], 'chemin_vers_votre_dossier/' . $name_gen);
            } else {
